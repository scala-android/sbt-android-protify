...
3. Add the protify plugin:
   `echo 'addSbtPlugin("com.hanhuy.sbt" % "android-protify" % "0.1")' > project/plugins.sbt`
...
2. add the dependency `compile 'com.hanhuy.android:protify:0.1'` to the flavor
...
3. Add ~/.ivy/cache/com.hanhuy.android/protify/jars/protify-0.1.jar to your
   module dependencies
